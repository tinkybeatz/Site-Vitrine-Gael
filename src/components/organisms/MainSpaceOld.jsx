...
export function MainSpace({ nb }) {
  ...
  return (
    <div className="w-[90%] h-auto xl:mt-10 lg:mt-8 sm:mt-8 drop-shadow-md" ref={horRef} id={nb.key}>
      <div className="parent-container grid xl:p-4 lg:p-4 sm:px-2 sm:py-3 grid-cols-9 drop-shadow-md bg-gray-200 dark:bg-zinc-500 dark:text-white transition duration-200 rounded-lg">
