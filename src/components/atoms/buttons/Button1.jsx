export function Button1({ href, text, onClick }) {
  ...
  return (
    <a href={`/#${href}`}>
      <button
      className={`xl:min-w-[80px] lg:min-w-[80px] sm:w-[40px] bg-purple-500 xl:p-2 lg:p-2 sm:p-0 rounded-lg flex justify-center items-center drop-shadow-md text-white border-2 border-purple-500
