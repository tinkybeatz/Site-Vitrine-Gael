export function CardProject({ cardInfo }) {
  ...
  //affichage
  return (
    <div className="shrink-0 divide flex-row relative rounded-md drop-shadow-md h-96 w-80 bg-white dark:bg-zinc-700 text-black dark:text-white transition-all duration-200 mr-4">
      ...
      <div className="flex-row h-4/5 p-4 bg-gray-100 transition-all duration-200 dark:bg-zinc-800 rounded-b-md">
        <p className="text-black dark:text-white font-normal transition-all duration-200 mb-4">
