    ...
    <div className="">
      <div className="grid grid-cols-3 bg-gray-300 rounded-md dark:bg-zinc-600 transition-all duration-200">
        <div className="grid col-span-2 grid-cols-1 h-full w-full justify-center items-center">
          {deploy.texts.map((nb) => (
            <div className="flex col-span-1 h-5/6 px-5 mx-5 text-lg text-black dark:text-white items-center bg-gray-100 drop-shadow-md dark:bg-zinc-700 transition-all duration-200 rounded-md">
              {nb}
            </div>
          ))}
        </div>
