...
//   return (
//     <div
//       class="xl:w-[600px] lg:w-[280px] sm:w-[260px] xl:h-[60px] lg:h-[40px] sm:h-[50px] bg-purple-500 grid grid-cols-7 rounded-lg fixed z-50 bottom-4 inset-x-0 mx-auto xl:py-2 lg:py-1 sm:py-0.5 shadow-2xl"
//       // ref={horRefNav}
//     >
//       <div class="col-span-1 grid justify-center items-center xl:text-xl lg:text-lg sm:text-[16px] dark:text-black transition-all duration-200 text-white xl:border-r-2 lg:border-r-2 sm:border-0 border-purple-900 sm:ml-1">
//         <p className="font-midnight">Gaël</p>
//       </div>
...
//         <a href="#" class="flex rounded-lg dark:bg-zinc-600 w-auto text-purple-500 justify-items-center lg:text-xs sm:text-[14px] align-items-center dark:text-white bg-white xl:py-2 xl:px-3 lg:px-2 lg:py-1 sm:px-2 sm:py-1 transition-all duration-200 xl:font-semi-bold lg:font-medium col-span-1 leading-normal">
//           Back to the top
//         </a>
//       </div>
//       <div class="col-span-2 xl:border-r-2 lg:border-r-2 sm:border-0 border-purple-900 flex items-center text-center justify-center">
//         <a
//           href={Resume}
//           class="flex rounded-lg dark:bg-zinc-600 w-auto text-purple-500 justify-items-center lg:text-xs sm:text-[14px] align-items-center dark:text-white bg-white xl:py-2 xl:px-3 lg:px-2 lg:py-1 sm:px-2 sm:py-1 transition-all duration-200 xl:font-semi-bold lg:font-medium col-span-1 leading-normal"
...
//         <div class="hover:cursor-pointer w-auto xl:py-2.5 xl:px-3 lg:py-1.5 lg:px-2 sm:py-1.5 sm:px-2 flex rounded-lg bg-white dark:bg-zinc-600 transition-all duration-200 items-center ">
//           <DarkModeSwitch
//             style={{}}
//             key={"darkModeSwitch"}
//             checked={darkSide}
...
//             target="_blank"
//             class="flex rounded-lg dark:bg-zinc-600 w-auto text-purple-500 justify-items-center lg:text-xs sm:text-[14px] align-items-center dark:text-white bg-white transition-all duration-200 xl:font-semi-bold lg:font-medium col-span-1 leading-normal"
//           >
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
//               width="24"
